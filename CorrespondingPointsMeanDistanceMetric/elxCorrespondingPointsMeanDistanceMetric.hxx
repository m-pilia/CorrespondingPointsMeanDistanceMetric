 ...
 *
 *=========================================================================*/
#ifndef __elxCorrespondingPointsMeanDistanceMetric_HXX__
#define __elxCorrespondingPointsMeanDistanceMetric_HXX__

#include "elxCorrespondingPointsMeanDistanceMetric.h"
...
void
CorrespondingPointsMeanDistanceMetric< TElastix >
::Initialize( void ) throw ( itk::ExceptionObject )
{
  ...
  timer.Stop();
  elxout << "Initialization of CorrespondingPointsMeanDistance metric took: "
...
::BeforeAllBase( void )
{
    ...
    ->CountNumberOfParameterEntries( "Metric" ); ++i )
  {
    ...
    if( metricName == "CorrespondingPointsMeanDistanceMetric" ) { count++; }
  }
  if( count == 0 ) { return 0; }

  /** Check Command line options and print them to the log file. */
  elxout << "Command line options from CorrespondingPointsMeanDistanceMetric:" << std::endl;
  std::string check( "" );
...
#endif // end #ifndef __elxCorrespondingPointsMeanDistanceMetric_HXX__
